...
const delete_user_use_case_1 = require("../../../App/useCases/users/delete.user.use.case");
...
], DeleteUserController.prototype, "execute", null);
exports.DeleteUserController = DeleteUserController = __decorate([
    (0, common_1.Controller)('user/delete/'),
