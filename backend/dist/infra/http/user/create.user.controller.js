...
const create_user_use_case_1 = require("../../../App/useCases/users/create.user.use-case");
const createUserDto_1 = require("../../../shared/dtos/user/createUserDto");
...
exports.CreateUserController = CreateUserController = __decorate([
    (0, common_1.Controller)('user/register'),
    __metadata("design:paramtypes", [create_user_use_case_1.RegisterUserUseCase])
